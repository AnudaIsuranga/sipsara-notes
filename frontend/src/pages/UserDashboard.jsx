...
export default function UserDashboard() {
  ...
  if (!user) {
    return <p className="text-center mt-20 text-gray-600">Please log in to view your profile.</p>;
  }
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100 border-l-4 border-l-blue-500">
              ...
              <p className="text-gray-600">
                You now have full access to our educational database. Click on the <strong>Notes</strong> tab above to start searching and viewing materials.
              </p>
            </div>
