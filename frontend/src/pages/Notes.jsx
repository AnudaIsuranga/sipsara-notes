        ...
        <div className="mb-12">
          ...
          <div className="flex justify-between items-end">
            ...
            {selectedLevel && (
              <button
                onClick={goBack}
                className="bg-white border-2 border-gray-200 px-6 py-2 rounded-xl font-black text-gray-700 hover:border-blue-600 hover:text-blue-600 transition-all shadow-sm"
              >
                ← Go Back
              </button>
            )}
