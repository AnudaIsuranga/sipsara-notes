    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-black text-gray-900 mb-4">Our <span className="text-blue-600">Professionals</span></h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            {teachers.map(t => (
              <div key={t._id} className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
                ...
                <div className="p-8">
                  <h2 className="text-2xl font-bold text-gray-900 mb-1 uppercase tracking-tight">{t.name}</h2>
